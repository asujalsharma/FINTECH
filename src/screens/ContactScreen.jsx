...
const ContactScreen = () => {
  ...
  const emailUs = () => {
    Linking.openURL('mailto:CellPe.in@gmail.com');
  };
  ...
  const ratePlayStore = () => {
    Linking.openURL('market://details?id=com.CellPe');
  };
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {/* Footer */}
        <Text style={styles.footer}>Made with ❤ by CellPe</Text>
      </ScrollView>
    </SafeAreaView>
  );
};
  ...
  return (
    <TouchableOpacity style={styles.button} onPress={onPress}>
      <View style={styles.buttonLeft}>
        <IconComponent name={icon} size={22} color="#10306b" />
