...
const ContactScreen = () => {
  ...
  const emailUs = () => {
    Linking.openURL('mailto:AADYAPay.in@gmail.com');
  };
  ...
  const ratePlayStore = () => {
    Linking.openURL('market://details?id=com.AADYAPay');
  };
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        {/* Footer */}
        <Text style={styles.footer}>Made with ❤ by AADYAPay</Text>
      </ScrollView>
    </SafeAreaView>
  );
};
  ...
  return (
    <TouchableOpacity style={styles.button} onPress={onPress}>
      <View style={styles.buttonLeft}>
        <IconComponent name={icon} size={22} color="#647CF0" />
        <Text style={styles.buttonText}>{text}</Text>
      </View>
      <Icon name="chevron-right" size={22} color="#647CF0" />
    </TouchableOpacity>
  );
};
