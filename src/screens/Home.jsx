    ...
    <Modal visible={showModal} transparent animationType="fade">
      <View style={styles.popupBackdrop}>
        <View style={styles.popupContainer}>
          ...
          <Image
            source={{ uri: `https://api.charlie.techember.in/${POPUP.image}` }}
          ...
          <View style={styles.headerRow}>
            ...
            <View style={styles.headerActions}>
              <TouchableOpacity
                ...
                onPress={() => {
                  Linking.openURL(
                    'https://whatsapp.com/channel/0029Vajz38GCcW4yWd6Z0m08',
                  );
                }}
              >
          ...
          <FlatList
            ...
            renderItem={({ item }) => (
              ...
              >
                <Image
                  source={{
                    uri: 'https://api.charlie.techember.in/' + item.image,
                  }}
              ...
              {filteredOrderList['recharge'].map((item, idx) => (
                <View key={idx} style={styles.cardWrapper}>
                  ...
                  >
                    <Image
                      source={{
                        uri: 'https://api.charlie.techember.in/' + item.icon,
                      }}
                      style={styles.image}
                    />
                    <View>
