    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.intro}>
          At <Text style={styles.highlight}>AADYAPay</Text>, we are committed to
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            This policy applies to all users of AADYAPay’s website, mobile app,
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            AADYAPay’s products, services, or operations that requires a formal
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.listItem}>
            ...
            <Text style={styles.link}>support@AADYAPay.in</Text> with full
            transaction details.
          </Text>
          <Text style={styles.listItem}>
            • **Website Contact Form:** Use the “Contact Us” form available on{' '}
            <Text style={styles.link}>www.AADYAPay.in</Text>.
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.contact}>📧 grievance@AADYAPay.in</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>Every AADYAPay user has the right to:</Text>
          <Text style={styles.listItem}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            AADYAPay reserves the right to amend or update this Grievance Policy
        ...
        <View style={styles.footer}>
          <Text style={styles.text}>
            At AADYAPay, your satisfaction is our top priority. We are dedicated
            to resolving all customer concerns fairly, efficiently, and
            transparently.
          </Text>
          <Text style={styles.contact}>📧 support@AADYAPay.in</Text>
          <Text style={styles.contact}>🌐 www.AADYAPay.in</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
