    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.intro}>
          At <Text style={styles.highlight}>CellPe</Text>, we are committed to
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            This policy applies to all users of CellPe’s website, mobile app,
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            CellPe’s products, services, or operations that requires a formal
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.listItem}>
            ...
            <Text style={styles.link}>support@CellPe.in</Text> with full
            transaction details.
          </Text>
          <Text style={styles.listItem}>
            • **Website Contact Form:** Use the “Contact Us” form available on{' '}
            <Text style={styles.link}>www.CellPe.in</Text>.
          </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.contact}>📧 grievance@CellPe.in</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>Every CellPe user has the right to:</Text>
          <Text style={styles.listItem}>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe reserves the right to amend or update this Grievance Policy
        ...
        <View style={styles.footer}>
          <Text style={styles.text}>
            At CellPe, your satisfaction is our top priority. We are dedicated
            to resolving all customer concerns fairly, efficiently, and
            transparently.
          </Text>
          <Text style={styles.contact}>📧 support@CellPe.in</Text>
          <Text style={styles.contact}>🌐 www.CellPe.in</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
