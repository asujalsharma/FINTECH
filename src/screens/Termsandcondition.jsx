    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.intro}>
          Welcome to <Text style={styles.highlight}>CellPe</Text>. Your use of
          CellPe on our Website or Mobile App is governed by the following Terms
        ...
        <Text style={styles.text}>
          ...
          <Text style={styles.link}>support@CellPe.in</Text>.
        </Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            those previously suspended by CellPe. By using the Site, you confirm
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            <Text style={styles.link}>support@CellPe.in</Text> immediately.
          </Text>
        </View>

        {/* Section 4 */}
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>4. CellPe Recharges</Text>
          <Text style={styles.text}>
            CellPe acts solely as a reseller of prepaid mobile and DTH services.
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.listItem}>
            • CellPe is not liable for delays beyond its control.
          </Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Privacy of communication is governed by RBI regulations. CellPe may
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            All materials, trademarks, and content on the Site belong to CellPe
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe provides its services on an “as is” and “as available” basis
            without warranties of any kind. We do not guarantee uninterrupted
            service, accuracy, or freedom from errors. CellPe shall not be
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            You agree to indemnify and hold CellPe and its affiliates harmless
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe and its associates will not be liable for indirect,
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            By accepting these Terms, you authorize CellPe to process and
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            be credited to your CellPe account or original payment method.
          </Text>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.text}>
            By continuing to use CellPe, you confirm that you have read and
