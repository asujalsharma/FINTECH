    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.intro}>
          At <Text style={styles.highlight}>AADYAPay</Text>, accessible from{' '}
          <Text style={styles.link}>https://AADYAPay.in</Text>, protecting your
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            AADYAPay follows a standard log file procedure. These files log
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Like most websites, AADYAPay uses cookies to store user preferences
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            AADYAPay has no control over cookies used by third-party
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            AADYAPay’s Privacy Policy does not apply to external websites or
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Protecting children’s privacy is a top priority. AADYAPay does not
