    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        ...
        <Text style={styles.intro}>
          At <Text style={styles.highlight}>CellPe</Text>, accessible from{' '}
          <Text style={styles.link}>https://CellPe.in</Text>, protecting your
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe follows a standard log file procedure. These files log
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Like most websites, CellPe uses cookies to store user preferences
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            CellPe has no control over cookies used by third-party advertisers.
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe’s Privacy Policy does not apply to external websites or
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            Protecting children’s privacy is a top priority. CellPe does not
