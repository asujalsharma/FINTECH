...
// else define COLORS.primary = '#252222ff';
      ...
      >
        ...
        <View style={styles.header}>
          {/* <Image
            ...
            resizeMode="contain"
          /> */}
          <Text style={styles.title}>Welcome to EasyPe!</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            EasyPe embarked on its exciting journey on{' '}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            effortless, secure, and accessible to everyone. With EasyPe, we’re
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.text}>
            Be part of the EasyPe journey — where technology meets trust, and
