...
// else define COLORS.primary = '#10306b';
      ...
      >
        ...
        <View style={styles.header}>
          {/* <Image
            ...
            resizeMode="contain"
          /> */}
          <Text style={styles.title}>Welcome to CellPe!</Text>
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            CellPe embarked on its exciting journey on{' '}
        ...
        <View style={styles.section}>
          ...
          <Text style={styles.text}>
            ...
            effortless, secure, and accessible to everyone. With CellPe, we’re
        ...
        <View style={styles.footer}>
          ...
          <Text style={styles.text}>
            Be part of the CellPe journey — where technology meets trust, and
